...
const config = {
        ...
        state: {
            ...
            graph: {
                nodes: [
                    {id: 1, label: 'node1', x: Math.random(), y: Math.random(), color: "#32b432", size: 1},
                    {id: 2, label: 'node2', x: Math.random(), y: Math.random(), color: "#32b432", size: 2},
                    {id: 3, label: 'node3', x: Math.random(), y: Math.random(), color: "#32b432", size: 3}
                ],
                edges: [
                    {id: 1, label: 'test', source: 1, target: 2, color: "#f70017", size: 10},
                    {id: 2, label: 'test', source: 2, target: 3, color: "#f70017", size: 20},
                    {id: 3, label: 'test', source: 3, target: 1, color: "#f70017", size: 30}
                ]
            }
            ,
            meta: {
